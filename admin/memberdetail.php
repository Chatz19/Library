			...
			<form disabled>
				...
				<fieldset class = "name">
					...
					<div>
						<center>
							<?php if($r['approved'] == 0){ ?>
								<a href="accept.php?id=<?php echo $r['user_ID']; ?>&data=1">Accept</a>
							<?php } ?>
							<?php if($r['blocked'] == 0){ ?>
								<a href="block.php?id=<?php echo $r['user_ID']; ?>&data=1">block</a>
							<?php } else{?>
								<a href="block.php?id=<?php echo $r['user_ID']; ?>&data=0">Unblock</a>
							<?php } ?>
						</center>
					</div>
			</form>
